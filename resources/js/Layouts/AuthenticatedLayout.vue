...
<template>
    <div>
        <div class="min-h-screen bg-tertiary">
            <nav class="bg-secondary border-b border-zinc-800">
                                ...
                                <Dropdown align="right" width="48">
                                    <template #trigger>
                                        <span class="inline-flex rounded-md">
                                            <button
                                                type="button"
                                                class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-300 bg-zinc-900 hover:text-gray-200 focus:outline-none transition ease-in-out duration-150"
                                            >
